...
all_lines = findobj(ax,"-property","XData");
grid_lines = findobj(ax,"Tag","grid_line");
outline = findobj(ax,"Tag","outline");
set(all_lines,"Visible","off")
set(groot,"ShowHiddenHandles","off");

orbit = findobj(lines,"-regexp","Tag","^o");
manifold = [findobj(lines,"Tag","m-1,2");grid_lines;outline];
validation_manifold = findobj(lines,"Tag","validation_manifold");
switch animation_step
    case 1
        set(orbit(2),"Visible","on")
    case 2
        set(orbit(2),"Visible","on")
        set(manifold,"Visible","on")
    case 3
        set(orbit,"Visible","on")
        set(manifold,"Visible","on")
        set(validation_manifold,"visible","on")

end


%-----------------------------------------
save_fig(fig,fig_name+"_"+animation_step)
