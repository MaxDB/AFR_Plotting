...
error_ax = data_dir_execute(@compare_validation,"clamped_beam_13","validation error",sol_num,[2,6]);
error_fig = gcf;

Dyn_Data = data_dir_execute(@initalise_dynamic_data,"clamped_beam_13");
