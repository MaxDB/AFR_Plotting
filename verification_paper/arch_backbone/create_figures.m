...
data_dir_execute(@compare_solutions,"physical amplitude","mems_arch_16","all");
fig = gcf;
...
marker_style = {"Marker","o","MarkerSize",4,"MarkerFaceColor",get_plot_colours(1)};
set(ax.Children,marker_style{:})
